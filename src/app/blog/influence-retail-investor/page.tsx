                    ...
                    <section className="space-y-4">
                        ...
                        {zh ? (
                            <>
                                ...
                                <p>一个金融博主分享了一份关于某小盘股的详细论据。内容翔实、排版精美，看起来像是出于慷慨。随之而来的是<strong>不对等的交换</strong>：你买入，为分发这份&ldquo;礼物&rdquo;的人提供了流动性。这就是拉盘。你的资本，就是那份互惠的让步。</p>
                    ...
                    <section className="space-y-4">
                        ...
                        {zh ? (
                            <>
                                ...
                                <p>你在 Reddit 上发帖：&ldquo;重仓 $XYZ，这玩意儿要涨到 500 美元。&rdquo;股价跌了 30%。你没有止损，反而越跌越买，写出更长的帖子为论点辩护，拉黑批评者。你的<strong>行为强化了自己的承诺</strong>。这不是固执，而是对公开承诺在认知层面的正常反应。</p>
                    ...
                    <section className="space-y-4">
                        ...
                        {zh ? (
                            <>
                                ...
                                <p>那个穿得像你、说话像你、跟你分享对&ldquo;体制&rdquo;的不满、还夸你&ldquo;做了自己的研究&rdquo;很聪明的金融博主——这个人同时激活了所有的喜好开关。随后的荐股不会被当作推销接收，而是被当作来自可信朋友的建议。</p>
                    ...
                    <section className="space-y-4">
                        ...
                        {zh ? (
                            <>
                                ...
                                <p>社交媒体已经将权威的<em>表演</em>民主化了。一个精美的网站、自信的语气、精心筛选的过往&ldquo;成功预测&rdquo;，几乎可以零成本制造出专业外表。</p>
                            </>
                        ) : (
                            <>
                    ...
                    <section className="space-y-4">
                        ...
                        {zh ? (
                            <>
                                ...
                                <p>在市场中，FOMO 是散户的常伴。&ldquo;今晚优惠截止。&rdquo;&ldquo;私人 Discord 仅剩 500 个名额。&rdquo;&ldquo;预售在 6 小时后结束。&rdquo;每一句话都是人为制造的稀缺触发器。竞争条件——其他买家争夺同一资产——进一步放大了这种效应，这也是为什么拍卖机制总是导致超额支付。</p>
                    ...
                    <section className="space-y-4">
                        ...
                        {zh ? (
                            <>
                                ...
                                <p>散户投资者的任务不是消除启发式思维，而是识别那些支撑启发式判断的证据是否是伪造的。在每一个关键时刻，需要问的问题不是&ldquo;这感觉对吗？&rdquo;，而是&ldquo;是谁制造了这种感觉？&rdquo;</p>
                            </>
                        ) : (
                            <>
